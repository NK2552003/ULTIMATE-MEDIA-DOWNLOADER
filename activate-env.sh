...
activate() {
    ...
    if [ $? -eq 0 ]; then
        ...
        echo -e "${CYAN}│${NC}    ${BLUE}python3 ultimate_downloader.py <URL>${NC}                          ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}                                                                  ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}  ${GREEN}Show help:${NC}                                                     ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}    ${BLUE}python3 ultimate_downloader.py --help${NC}                         ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}                                                                  ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}  ${GREEN}Interactive mode:${NC}                                              ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}    ${BLUE}python3 ultimate_downloader.py -i${NC}                             ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}                                                                  ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}  ${GREEN}Download playlist:${NC}                                             ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}    ${BLUE}python3 ultimate_downloader.py -p <PLAYLIST_URL>${NC}              ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}                                                                  ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}  ${GREEN}Audio only:${NC}                                                    ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}    ${BLUE}python3 ultimate_downloader.py -a <URL>${NC}                       ${CYAN}│${NC}"
        echo -e "${CYAN}│${NC}                                                                  ${CYAN}│${NC}"
