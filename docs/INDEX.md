...
Welcome to the Ultimate Media Downloader documentation hub. This index will help you find exactly what you need.
...
3. [USER_GUIDE.md](USER_GUIDE.md) - Detailed usage
...
**Troubleshooting?** See:
1. [USER_GUIDE.md - FAQ Section](USER_GUIDE.md#faq)
...
### Configuration
- **[config.json](../config.json)** - Configuration file template
- **[Configuration Guide](USER_GUIDE.md#configuration)** - How to configure
...
- **[FLOWCHARTS.md](FLOWCHARTS.md)** - Visual process flows
...
### Development Journey
- **[HOW_IT_WAS_CREATED.md](HOW_IT_WAS_CREATED.md)** - Development story
  - Project inception
...
### Source Code
- **[ultimate_downloader.py](../ultimate_downloader.py)** - Main application (6,454 lines)
- **[generic_downloader.py](../generic_downloader.py)** - Generic handler (1,219 lines)
