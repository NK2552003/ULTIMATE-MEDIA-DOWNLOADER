...
class Umd < Formula
  ...
  homepage "https://codeberg.org/nk2552003/umd.git"
  url "https://codeberg.org/nk2552003/umd/archive/refs/tags/v2.2.1.tar.gz"
  sha256 "PLACEHOLDER_SHA256_UPDATE_AFTER_RELEASE"
  version "2.2.1"
  license "Apache-2.0"
  head "https://codeberg.org/nk2552003/umd.git", branch: "main"
  ...
  def install
    ...
    ENV.append "LDFLAGS", "-Wl,-headerpad_max_install_names"
        ...
        spec = "git+https://codeberg.org/nk2552003/umd.git@main#egg=ultimate-downloader"
